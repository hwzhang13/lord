package cc.lord.job.service.impl;

import cc.lord.common.annotation.CronTag;
import cc.lord.common.service.impl.BaseService;
import cc.lord.job.dao.JobMapper;
import cc.lord.job.domain.Job;
import cc.lord.job.service.JobService;
import cc.lord.job.util.ScheduleUtils;
...
public class JobServiceImpl extends BaseService<Job> implements JobService {
    ...
    public List<Job> getSysCronClazz(Job job) {
        Reflections reflections = new Reflections("cc.lord.job.task");
