...
import cc.lord.common.annotation.ExportConfig;
import cc.lord.common.handler.ExportHandler;
import cc.lord.common.util.poi.convert.ExportConvert;
import cc.lord.common.util.poi.pojo.ExportItem;
...
public class ExcelUtils {
    ...
    private void requiredbuilderParams() {
        if (mClass == null) {
            throw new IllegalArgumentException("请先使用cc.lord.util.ExcelUtils.builder(Class<?>)构造器初始化参数。");
        }
    }
    ...
    private void requiredexportParams() {
        if (mClass == null || mResponse == null) {
            throw new IllegalArgumentException(
                    "请先使用cc.lord.util.ExcelUtils.export(Class<?>, HttpServletResponse)构造器初始化参数。");
        }
